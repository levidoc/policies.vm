...
function start_installation() {
    const setup_container = document.getElementById('setup_container');
    ...
    setTimeout(function () {
        construct_slider_leader();
        setup_container.style.visibility = 'visible';
...
function redirect_window(set_location = false) {
    if (set_location == false) {
        set_location = window.location;
    }

    const setup_container = document.getElementById('setup_container');
    let x = document.getElementById('slider-loader-element');
    ...
    setTimeout(function () {
        window.location = set_location;
    }, 3000);
}

//Create a function that would be responsible for retriving the information from the server 
function retrieve_information_from_server() {

}

//Function for constructing the slider
function construct_slider_leader() {
    ...
    (function () {
        function e(b, c) { this.selector = null; c ? this.nodes = c : "string" == typeof b ? (this.selector = b, this.nodes = document.querySelectorAll(b)) : this.nodes = [b]; this.length = this.nodes.length; this.el = this.nodes[0] } function d(b) { return new e(b) } function k(b, c) {
            function l(a, c, d) {
                ...
                } f = a || {}; for (c in G) void 0 == f[c] && (f[c] = G[c]); f.captions = []; a = d("#" + b + " ol > li"); c = a.length; for (g = 0; g < c; g++) { f.captions[g] = []; for (var l = 0; slider_manual_limit > l; l++) { var e = { enable: V[l].enable, delay: V[l].delay }, t = d(a.get(g)).find(".ism-caption-" + l); 1 == t.length && (e.enable = !0, t = t.data("delay"), isNaN(t) || (e.delay = parseInt(t))); f.captions[g][l] = e } }
            } function r() {
